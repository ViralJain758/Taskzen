...
function Dashboard() {
  ...
  return (
    <div className="fade-up space-y-5">
      ...
      <div className="surface-card flex flex-col gap-2 rounded-2xl p-3 sm:flex-row sm:items-center sm:p-4">
        <input
          type="text"
          ...
          className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs text-slate-900 outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-200 sm:py-2.5 sm:text-sm md:max-w-lg"
        />
        <button
          onClick={handleCreate}
          disabled={!name.trim() || isCreating}
          className="rounded-xl bg-sky-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-sky-700 disabled:cursor-not-allowed disabled:bg-slate-400 sm:px-4 sm:py-2.5 sm:text-sm"
        >
